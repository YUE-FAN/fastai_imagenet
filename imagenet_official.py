...
def save_checkpoint(state, is_best, filename='/trained-models/imagenet/resnet50_official_lr0.6_bs256/checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, '/trained-models/imagenet/resnet50_official_lr0.6_bs256/model_best.pth.tar')
