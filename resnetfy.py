...
class Resnet152_Shuffle(nn.Module):
    def __init__(self, dropout_rate, num_classes, include_top, layer):
        print('Resnet152_Shuffle is used')
        super(Resnet152_Shuffle, self).__init__()
        self.dropout_rate = dropout_rate
        self.num_classes = num_classes
        self.include_top = include_top
        self.layer = layer
        identity = identity_block3_shuffle
        bottle = bottleneck_shuffle
