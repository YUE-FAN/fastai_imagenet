...
Examples:
python classwise_analysis.py -d imagenet -j 4 --dataset-path /BS/yfan/nobackup/ILSVRC2012/val/ --manualSeed 6 --gpu-id 1 --start-layer 33
-a resnet50_1x1lap --resume /BS/yfan/work/trained-models/dconv/checkpoints/imagenet/resnet501x1lap_90_lr0.1_bs256/
...
def create_dataloader(dataset_type, dataset_path):
    ...
    if dataset_type == 'cifar10':
        ...
        id2label = [name.split(',')[0] for i, name in imagenet_id2label.items()]  # imagenet_id2label has several names for one class, I take the first name
